...
class FeatureRegistry:
    ...
    def get_default_features(self):
        if not self.has_scanned_for_features: self._scan_for_features()
    ...
    def register_embed_type(self, handler): self.embed_types[handler.identifier] = handler
    ...
    def get_converter_rule(self, converter_name, feature_name):
        if not self.has_scanned_for_features: self._scan_for_features()
        try: return self.converter_rules_by_converter[converter_name][feature_name]
