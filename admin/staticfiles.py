...
# Check whether we should add cache-busting '?=...' parameters to static file URLs
try:
    # If a preference has been explicitly stated in the CONSOLE_STATIC_FILE_VERSION_STRINGS
    # setting, use that
    use_version_strings = settings.CONSOLE_STATIC_FILE_VERSION_STRINGS
except AttributeError:
    # If CONSOLE_STATIC_FILE_VERSION_STRINGS not specified, default to version strings
