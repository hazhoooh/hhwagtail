...
class DeleteBulkAction(PageBulkAction):
    display_name = "Delete"
    action_type = "delete"
    aria_label = "Delete selected pages"
    template_name = "cms/pages/bulk_actions/confirm_bulk_delete.html"
    action_priority = 30
    classes = {'serious'}
    ...
    def get_success_message(self, num_parent_objects, num_child_objects):
        if num_parent_objects == 1:
            if num_child_objects == 0:
                success_message = "1 page has been deleted"
            else:
            ...
            if num_child_objects == 0:
                success_message = "%(num_parent_objects)d pages have been deleted" % {'num_parent_objects': num_parent_objects}
            else:
                success_message = ngettext(
