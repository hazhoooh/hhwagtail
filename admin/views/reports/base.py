...
class ReportView(SpreadsheetExportMixin, TemplateResponseMixin, MultipleObjectMixin, View):
    header_icon = ""
    page_kwarg = "p"
    template_name = "cms/reports/base_report.html"
    title = ""
    paginate_by = 50
...
class PageReportView(ReportView):
    template_name = "cms/reports/base_page_report.html"
    export_headings = {
        "latest_revision_created_at": "Updated",
        "status_string": "Status",
        "content_type.model_class._meta.verbose_name.title": "Type",
    }
    list_export = [
        "title",
