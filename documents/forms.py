...
from .fields import WagtailDocumentField
...
def formfield_for_dbfield(db_field, **kwargs):
    ...
    if db_field.name == 'file':
        ...
        return CollectionChoiceField(label="Collection", queryset=Collection.objects.all(), empty_label=None, **kwargs)
...
def get_document_base_form():
    base_form_override = getattr(settings, "DOCS_DOCUMENT_FORM_BASE", "")
...
GroupDocumentPermissionFormSet = collection_member_permission_formset_factory(
    ...
    [
        ...
        ('choose_document', "Choose", "Select documents in choosers"),
    ],
