    ...
    def get_subpage_urls(cls):
        ...
        for klass in cls.__mro__:
            ...
            for val in klass.__dict__.values():
                if hasattr(val, '_routablepage_routes'): routes_for_class.extend(val._routablepage_routes)
            # sort routes by _creation_counter so that ones earlier in the class definition take precedence
